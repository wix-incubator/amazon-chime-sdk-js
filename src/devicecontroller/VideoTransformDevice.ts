...
export default interface VideoTransformDevice {
  ...
  /**
   * Starts the internal {@link VideoFrameProcessorPipeline} to process the input `MediaStream`
   * and returns the output `MediaStream`.
   */
  applyProcessors(mediaStream?: MediaStream): Promise<MediaStream>;

  /**
   * `outputMediaStream` is generated by {@link VideoFrameProcessorPipeline}. It will be auto-released after `stop` is called.
   */
